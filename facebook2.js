/*1735647619,,JIT Construction: v1019106050,en_US*/
 ...
 */
                    ...
                    var n = c("Type").extend({
                      ...
                      , o = {
                        ...
                        _createMobileLoader: function() {
                            ...
                            "Cancel") + "</a></div>" : a.innerHTML = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + c("sdk.fbt")._(/*BTDS*/
                            "Cancel") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + c("sdk.fbt")._(/*BTDS*/
    ...
    __fb_i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + __fb_err.name + '","line":"' + (__fb_err.lineNumber || __fb_err.line) + '","script":"' + (__fb_err.fileName || __fb_err.sourceURL || __fb_err.script || "sdk.js") + '","stack":"' + (__fb_err.stackTrace || __fb_err.stack) + '","revision":"1019106050","namespace":"FB","message":"' + __fb_err.message + '"}}');
